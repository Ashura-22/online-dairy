...
$paramList["CALLBACK_URL"] = "http://localhost/onlinedairy/PaytmKit/pgResponse.php?mail=$mail&pid=$pid&pquan=$pquan";
/*
...
<body>
    ...
    <form action="./pgResponse.php" method="POST">
        <input type="hidden" name="mailid" value="<?php echo $_POST['mail'];?>">
